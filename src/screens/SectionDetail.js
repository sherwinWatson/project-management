...
class SectionDetail extends Component {
  static navigationOptions = headerConfig('', true, (nav) => <AddUserButton navigation={nav}/>);
  ...
  render() {
    const { sectionId } = this.props.navigation.state.params
    const { navigation, section, isRefreshing, userSectionsRefreshing } = this.props
    ...
    return (
      <StyleProvider style={theme}>
        <Container style={{backgroundColor: color.white}}>
          <Content>
            <Loader loading={isRefreshing || userSectionsRefreshing} />
...
const mapStateToProps = (state) => ({
  ...
  userSections: state.storyboard.userSections.result.data,
  userSectionsRefreshing: state.storyboard.userSections.refreshing,
  userSectionsError: state.storyboard.userSections.error,
})
